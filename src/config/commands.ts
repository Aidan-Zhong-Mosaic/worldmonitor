...
export const COMMANDS: Command[] = [
  ...
  { id: 'panel:portfolio-exposure', keywords: ['portfolio', 'exposure', 'policies', 'book', 'underwriting exposure', 'affected policies', 'accumulation'], label: 'Panel: Portfolio Exposure', icon: '\u{1F4BC}', category: 'panels' },
