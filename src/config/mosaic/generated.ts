...
export const LOB_PANELS: Record<LobId, LobSelection> = {
  ...
  'cyber': {
    on: ['portfolio-exposure', 'map', 'live-news', 'security', 'cloud', 'service-status', 'cascade', 'security-advisories'],
  ...
  'transactional-liability': {
    on: ['portfolio-exposure', 'map', 'live-news', 'macro-signals', 'gcc-investments', 'tech', 'startups', 'unicorns', 'ipo', 'funding', 'fin-regulation', 'institutional'],
  ...
  'financial-institutions': {
    on: ['portfolio-exposure', 'map', 'live-news', 'heatmap', 'macro-signals', 'security', 'finance', 'crypto', 'ipo', 'etf-flows', 'stablecoins', 'markets-news', 'forex', 'bonds', 'centralbanks', 'economic-news', 'macro-tiles', 'fear-greed', 'market-breadth', 'derivatives', 'fintech', 'fin-regulation', 'institutional', 'national-debt'],
  ...
  'professional-liability': {
    on: ['portfolio-exposure', 'map', 'live-news', 'ai', 'tech', 'security', 'policy', 'cloud', 'service-status', 'ai-regulation', 'fintech', 'fin-regulation'],
  ...
  'environmental-liability': {
    on: ['portfolio-exposure', 'map', 'renewable', 'live-news', 'energy', 'mining-news', 'mining-companies', 'pipeline-status', 'energy-risk-overview', 'storage-facility-map', 'climate-news', 'population-exposure'],
  ...
  'specialty-casualty': {
    on: ['portfolio-exposure', 'map', 'live-news', 'storage-facility-map', 'disease-outbreaks', 'population-exposure'],
