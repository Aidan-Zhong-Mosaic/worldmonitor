---
title: "嵌入实时地图"
description: "只需一段 iframe 代码片段，即可将 World Monitor 公开的实时地图嵌入新闻文章、企业仪表盘、内部工具或作战室页面。本文档提供推荐尺寸、图层与主题参数、初始坐标缩放、深色模式、多种示例代码，以及常见集成场景的最佳实践与嵌入调优注意事项，帮助快速上线可交互态势地图。"
---
