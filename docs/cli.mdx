...
description: "Script country briefs, risk scores, and any of the 63 MCP tools from your shell with the official worldmonitor npm CLI — no API integration to write."
---
...
- **[MCP Tools Reference](/mcp-tools-reference)** — per-tool parameters, freshness budgets, and examples for all 63 tools.
