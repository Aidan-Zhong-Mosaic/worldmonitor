...
description: "Reproducible local packaging steps for the World Monitor desktop binary, including signing and notarization."
---
...
5. Validate bundle identity and in-app variant switching:
   ...
   - Switching to another variant reloads into that variant's panels/layers and
     survives a restart.
