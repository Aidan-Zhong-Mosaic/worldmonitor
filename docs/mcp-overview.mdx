...
See the [Tool catalog](#tool-catalog) above for the complete list of 63 tools, or the [MCP Tools Reference](/mcp-tools-reference) for per-tool details.
