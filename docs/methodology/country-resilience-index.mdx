...
description: "Real-time resilience scoring for 196 countries using 72 indicators across 21 dimensions and 6 domains — a 0-100 index refreshed every 6 hours at OECD/JRC parity."
---
...
See [`financial-system-exposure-flag-flip-runbook.md`](./financial-system-exposure-flag-flip-runbook.md) and the committed [`resilience-financial-system-exposure-acceptance-2026-08-13.json`](../snapshots/resilience-financial-system-exposure-acceptance-2026-08-13.json) snapshot for the operator procedure and measured result.
