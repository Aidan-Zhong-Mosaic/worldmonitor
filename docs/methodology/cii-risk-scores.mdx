...
> per-country baselines, event multipliers, climate-zone country attribution,
> strategic-risk roll-up coefficients, inline server formula literals, guarded
> top-level formula constants, or CII movement semantics MUST
> come with a bump of
