...
description: "How World Monitor curates the energy disruption event log surfaced on pipeline and storage asset drawers across the Energy Atlas map layer."
---
