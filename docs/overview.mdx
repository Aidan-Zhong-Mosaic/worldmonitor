...
| Language coverage | The interface supports 28 languages. Arabic and Persian use right-to-left layouts. This documentation site is currently available in English and Simplified Chinese. |
