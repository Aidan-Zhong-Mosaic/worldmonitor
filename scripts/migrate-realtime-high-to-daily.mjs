...
// which authenticates with CONVEX_DEPLOY_KEY (same path as the mutation below).
...
if (rulesResult.status !== 0) {
  console.error(`[migrate-realtime-high] getByEnabled failed (exit ${rulesResult.status}):`);
...
try {
  ...
  console.error("[migrate-realtime-high] getByEnabled returned unparseable output:");
