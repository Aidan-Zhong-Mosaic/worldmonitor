...
The proto-first API architecture (298 proto files, 36 typed services) means even the API contracts are transparent. You can see exactly what data each endpoint expects and returns.
