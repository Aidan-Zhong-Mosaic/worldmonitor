...
description: "Build intelligence apps on World Monitor's typed API: 36 services, 298 proto files, 80+ edge functions, and auto-generated TypeScript clients. AGPL-3.0."
...
- **298 proto files** defining every data structure and service
...
- **[World Monitor MCP Server](https://worldmonitor.app/mcp-server.md)** — the recommended agent surface at `https://worldmonitor.app/mcp`, with 63 tools over Streamable HTTP. Connect Claude, Cursor, or any MCP client. See the [MCP Overview](https://www.worldmonitor.app/docs/mcp-overview) for auth and the full catalog.
...
| Contracts | Protocol Buffers (298 files) |
| Desktop | Tauri (Rust) |
| Sidecar | Node.js |
| Caching | Redis |
...
Building an AI agent instead of an app? The same platform is exposed as a Model Context Protocol server with 63 live tools. See [how to connect Claude and other agents to World Monitor's MCP server](/blog/posts/worldmonitor-mcp-server-ai-agents-real-time-intelligence/).
...
**Start building at [github.com/koala73/worldmonitor](https://github.com/koala73/worldmonitor). 36 services, 298 proto files, and a global intelligence dataset waiting for your application.**
