...
//
// Dependency-free so Edge/esbuild server handlers can read the same table the
// browser bundle does. `src/config/bases-expanded.ts` re-exports this as
// `MilitaryBase[]`, which is what pins MilitaryBaseRecord to that contract.

export type MilitaryBaseRecordType =
  | 'us-nato'
  | 'china'
  | 'russia'
  | 'uk'
...
export const MILITARY_BASES_EXPANDED: MilitaryBaseRecord[] = [
